...
| 5 | ScientificObjectRevision | `consumed_as_input_by` | RunReference \| SessionReference | 0..* | yes | **global** |
...
- Rule of thumb: **structural** invariants (distinctness, membership, known enum,
  ...
  kinds per `relation_type`, single-owner edges) in the domain service.
