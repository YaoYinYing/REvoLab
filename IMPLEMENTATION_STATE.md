...
- GitHub Actions CI is green on the architecture PR (head `93544af`, GHA run #14): backend Ruff/mypy/pytest + Alembic `upgrade head`/`check` against PostgreSQL 16; frontend typecheck/test/build all pass.
