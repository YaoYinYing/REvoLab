...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('user', 'assistant', name='conversation_role', native_enum=False), nullable=False),
        sa.Column('content', sa.Text(), nullable=False),
        sa.Column('termination_reason', sa.Enum('final_response', 'max_model_turns', 'max_tool_calls', 'total_duration', 'model_unavailable', name='agent_termination_reason', native_enum=False), nullable=True),
