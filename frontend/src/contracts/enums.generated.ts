...
export const CAPABILITY_KINDS: readonly components['schemas']['CapabilityKind'][] = ["compute","artifact_resolution","literature_discovery","protein_discovery","structure_discovery"] as const
